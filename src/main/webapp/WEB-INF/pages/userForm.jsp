        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <form:form id="userRegisterForm" cssClass="form-horizontal" modelAttribute="user" method="post" action="saveUser">
                    ...
                    <div class="form-group">
                        <div class="control-label col-xs-3"><form:label path="status">Status</form:label></div>
                        <div class="col-xs-6">
                            <form:input cssClass="form-control" path="status" value="${userObject.status}"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="control-label col-xs-3"><form:label path="date">Date</form:label></div>
                        <div class="col-xs-6">
                            <form:input cssClass="form-control" path="date" value="${userObject.date}"/>
                        </div>
                    </div>
